                ...
                >
                  <div className="w-9 h-9 rounded-full bg-brand-accent/20 flex items-center justify-center shrink-0 mt-0.5">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {cc.lastMessage ? (
                        <>
                          <span className="font-semibold text-slate-300">{cc.lastMessage.sender_name || 'Unknown'}: </span>
      ...
      <main className="flex-1 bg-brand-light-bg flex flex-col overflow-hidden">
        {activeChatClient ? (
          <>
            ...
            <form onSubmit={handleSubmit} className="p-3 border-t border-slate-200 flex gap-2 shrink-0 bg-white">
              <input
                type="text"
                required
