                ...
                <div className="border-t border-slate-200 px-4 py-3 space-y-3 bg-slate-50/50">
                  ...
                  <div className="flex items-center gap-2 flex-wrap pt-1">
                    <button
                      ...
                      className="flex items-center gap-1.5 px-3 py-1.5 bg-brand-accent hover:bg-brand-accent-hover text-white text-[10px] font-bold rounded transition cursor-pointer"
                    >
